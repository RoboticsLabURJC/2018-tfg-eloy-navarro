...
%%--------------------------------------------------------------
\begin{hslide}
\slsubsect{Estaci\'on de tierra basada en FPGA - Arquitectura}
\begin{minipage}{3cm}
	\begin{center}
		\begin{figure}
...
\begin{minipage}{6.2cm}
	\begin{itemize}
		\item Biblioteca en Python
		\item \textbf{Facilita el control} del veh\'iculo desde programas ejecutados en el ordenador
...
%%--------------------------------------------------------------
\begin{hslide}
\slsubsect{Ordenador de Mando - Funciones}
\begin{center}
...
\begin{itemize}
	%\item A\~nadidos: Visi\'on artificial, GPS...
	%\item Mejoras: Generador de trayectorias
	%\item Cambios: Arquitectura basada en FPGA a bordo
