...
\subsubsection{Prueba del módulo decodificador de tramas desde drone}
...
Dos prestaciones fundamentales que condicionan la calidad de los bucles de control son el ancho de banda y las latencias involucradas en un sistema concreto. A continuación se describe el análisis realizado de ellos para el bucle de control del drone desde la estación de tierra.
