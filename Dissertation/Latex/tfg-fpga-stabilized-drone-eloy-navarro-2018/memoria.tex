...
Para el control del vehículo en vuelo, mediante un PC, es necesario establecer comunicación con él desde tierra. Dicha comunicación se realiza exclusivamente por radio, mediante dos canales independientes como se muestra en la sección \textit{Módulo en Vuelo} de la Figura~\ref{fig:NewSystArq}.\\
Esta interfaz, define ambos, el primero comunica la FPGA de la estación de tierra con la electrónica propia del dron y el segundo con los sensores instalados a bordo. Estos son los interfaces \textit{Órdenes de movimiento} y \textit{Medidas de sensores} respectivamente. Su objetivo es que la estación de tierra conozca la posición del dron y en base a esta, realice el control sobre el mismo. En su conjunto se trata de un enlace radio bidireccional entre la estación de tierra y el dron, con dos canales trabajando en la banda libre de 2.4GHz, separados en frecuancia. De esta manera se consigue un enlace bidireccional, full-duplex, mediante separación en frecuencia (FDM). Lo que permite transmisión de información de subida y de bajada simultaneas, sin colisiones. Evita también preocuparse de la complejidad y la bajada en la tasa de transferencia propia de un sistema de multiplexación por división en código (CDM), o sistemas de mayor complejidad. A continuación se explican ambos canales:
