...
Tras las pruebas iniciales sobre drones y módulos se procede con un ensayo completo de vuelo. Para ello, se lleva a cabo un ejercicio que incluye desde la ejecución en PC del software de mando, hasta el vuelo y aterrizaje autónomos del dron. Se trata de un viaje de ida y vuelta mostrado en la secuencia de imágenes de la Figura~\ref{fig:vuelo_completo}.
