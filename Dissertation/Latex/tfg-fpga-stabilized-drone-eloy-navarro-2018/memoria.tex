...
Tras las pruebas unitarias realizadas sobre los drones Eachine E010, Syma X5C y módulos software se procede a un ensayo completo de vuelo. Para ello se hace uso del sistema final, compuesto por el ordenador ejecutando las instrucciones de mando en Python, la estación de tierra con la FPGA programada para ejecutar el control de vuelo y el dron X5C con la electrónica de a bordo transmitiendo su posición. El ejercicio realizado incluye desde la ejecución en PC del software de mando hasta el vuelo y aterrizaje del dron, controlado desde tierra. Se trata de un viaje de ida y vuelta \cite{Dron_idaVuelta} mostrado en la secuencia de imágenes de la Figura~\ref{fig:vuelo_completo}. Adicionalmente se realizaron ensayos de despegue y aterrizaje controlado \cite{Dron_Aterrizaje} y comprobación de la estabilidad en vuelo estacionario \cite{Dron_estacionario}.
