...
La lógica construida en la FPGA se encarga de procesar información sobe la posición actual y la posición deseada para el vehículo, generando órdenes de movimiento que dirijan el dron hacia la posición deseada. Para ello la arquitectura software diseñada, se vale de tres puertos de comunicaciones y cuatro lineas de procesado paralelas. La relación entre estos elementos se muestra en la arquitectura de la Figura~\ref{fig:FPGA_New_arq}.\\
